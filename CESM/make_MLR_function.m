...
% this function is to make a model function based on
% stepwise multilinear regression results. Input 
% argumnet 'mdl' is MLR results, which contains 
% effective parameter names, coefficients; and 
% 'tbl' is parameters organized
% in columns. Output 'func' is MLR model prediction.
    func = 0;
